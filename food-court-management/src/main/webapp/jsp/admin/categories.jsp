    ...
    <div class="row g-4">
        <div class="col-lg-3">
            <div class="list-group fc-sidebar">
                ...
                <a href="${pageContext.request.contextPath}/admin/categories" class="list-group-item list-group-item-action active">品类管理</a>
        ...
        <div class="col-lg-9">
            <div class="fc-card p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h4 class="fw-bold mb-1">品类管理</h4>
                        <div class="text-muted">维护美食街品类与排序优先级</div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <form action="${pageContext.request.contextPath}/admin/categories" method="get" class="d-flex align-items-center gap-2">
                            <input type="text" class="form-control form-control-sm" name="keyword" value="${param.keyword}" placeholder="搜索品类名称">
                        ...
                        <tbody>
                            <c:forEach items="${categories}" var="cat">
                                <tr>
                                    ...
                                    <td>${cat.sortOrder}</td>
                                    <td>${cat.regionCapacity != null ? cat.regionCapacity : 20}</td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/categories" method="post" class="d-flex align-items-center gap-2">
                                            <input type="hidden" name="action" value="updateCapacity">
                                            <input type="hidden" name="id" value="${cat.id}">
                                            <input type="number" class="form-control form-control-sm" name="regionCapacity" min="0" value="${cat.regionCapacity != null ? cat.regionCapacity : 20}" required>
                                            <button type="submit" class="btn btn-sm btn-outline-dark">保存</button>
                                        </form>
                                    </td>
                                </tr>
                            </c:forEach>
